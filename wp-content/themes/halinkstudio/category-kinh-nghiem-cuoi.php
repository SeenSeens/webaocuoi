                                    ...
                                    if (have_posts()) :
                                        while ($service->have_posts()) :
                                            ...
                                            <div class="post-item isotope-item clearfix post type-post status-publish format-standard has-post-thumbnail hentry">
                                                <div class="date_label"><?php the_modified_date(); ?></div>
                                                        ...
                                                        <div class="post-head">
                                                            <div class="post-meta clearfix">
                                                                <div class="author-date">
                                                                    <span class="vcard author post-author"><span class="label">Published by </span><i class="icon-user"></i> <span class="fn"><a href=""><?php the_author(); ?></a></span></span> <span class="date"><span class="label">at </span><i class="icon-clock"></i> <span class="post-date updated"><?php the_modified_date(); ?></span></span>
