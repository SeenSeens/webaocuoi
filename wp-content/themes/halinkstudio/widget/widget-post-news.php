<?php
class WG_Post_News extends WP_Widget
{
    public function __construct() {
		$widget_ops = array(
			'classname'                   => 'WG_Post_News',
			'description'                 => __( 'Các bài viết mới nhất hiện nay' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'new-posts', __( 'Bài viết mới nhất' ), $widget_ops );
		$this->alt_option_name = 'WG_Post_News';
	}
